...
crunch domain_time_scheduler_action_inv [wp, DetSchedDomainTime_AI_assms]: arch_finalise_cap "\<lambda>s. P (domain_time s) (scheduler_action s)"
  (wp: crunch_wps simp: crunch_simps)

crunch domain_time_scheduler_action_inv [wp, DetSchedDomainTime_AI_assms]:
  arch_activate_idle_thread, arch_switch_to_thread, arch_switch_to_idle_thread,
...
crunch domain_consumed_time_scheduler_action_inv [wp, DetSchedDomainTime_AI_assms]:
  arch_switch_to_idle_thread,arch_switch_to_thread "\<lambda>s. P (domain_time s) (consumed_time s) (scheduler_action s)"
  (simp: whenE_def)
...
crunches arch_perform_invocation, arch_mask_irq_signal
  for domain_time_scheduler_action_inv [wp, DetSchedDomainTime_AI_assms]: "\<lambda>s::det_state. P (domain_time s) (scheduler_action s)"
...
crunch domain_time_scheduler_action_inv [wp, DetSchedDomainTime_AI_assms]: handle_reserved_irq "\<lambda>s. P (domain_time s) (scheduler_action s)"
